...
const Home = () => {
  ...
  return (
      ...
      <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
        ...
        <a href="/auth/sign-in" className="flex items-center gap-2 border border-slate-700 rounded-full p-1 pr-3 text-sm mt-20">
        ...
        <h1 className="text-center text-[40px] leading-[48px] md:text-6xl md:leading-[70px] mt-4 font-semibold max-w-3xl">
          AI That transform ideas into slides.
        </h1>

        <p className="text-center text-base max-w-md mt-2">
          Design, customize, and present site faster with AI-powered intelligence.
        </p>
...
<div className="flex flex-wrap items-center justify-center gap-14 md:gap-20 mx-auto mt-16">
  ...
  {/* Netflix */}
  <img
    src="https://cdn.simpleicons.org/netflix/white"
    alt="Netflix"
    className="h-8 md:h-10 w-auto object-contain"
  />
