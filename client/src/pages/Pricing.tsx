    ...
    <>
      <div className='w-full max-w-5xl mx-auto z-20 max md:px-4 min-h-[80vh]'>
        <div className='text-center mt-16'>
          <h2 className='text-3xl font-semibold text-gray-100'>Choose the plan that fits your needs</h2>
          <p className='text-gray-400 text-sm max-w-md mx-auto mt-2'>Start building your projects with our flexible pricing options. Find the right plan for you.</p>
        </div>
        <div className='pt-14 py-4 px-4 '>
                ...
                <p className='mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light'>Project <span className='text-white'>Creation / Revision</span> consume <span className='text-white'>5 Creits</span>. You can purchase more credits in the billing section.</p>
      </div>
      <Footer />
    </>
  )
